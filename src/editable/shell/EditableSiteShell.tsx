...
export function EditableSiteShell({ children, className = '' }: { children: ReactNode; className?: string }) {
  return (
    <div className={`${dc.shell.page} relative flex min-h-screen flex-col overflow-x-clip ${className}`}>
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[520px] bg-[radial-gradient(circle_at_top_left,rgba(200,255,0,0.04),transparent_48%),radial-gradient(circle_at_top_right,rgba(200,255,0,0.02),transparent_42%)]" />
      <EditableNavbar />
